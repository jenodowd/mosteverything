    ...
    return (
      <div className = "sideNavContainer">
        <ul className="sideNavUL">
          ...
          <Link className="sidelink" to={'/pink/'}> <img src = "http://localhost:3000/pink.jpg"/> </Link> 
          <Link className="sidelink" to={'/blue/'}> <img src = "http://localhost:3000/blue.jpg"/> </Link> 
          <Link className="sidelink" to={'/white/'}> <img src = "http://localhost:3000/white.jpg"/> </Link> 
        </ul>
      </div>
    )
  }
