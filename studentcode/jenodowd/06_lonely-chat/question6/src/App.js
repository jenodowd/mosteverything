...
class App extends Component {
  ...
  constructor() {
    super()
    this.state = { user: "", inputContentLeft: "", inputContentRight: "", msgsLeft: [], msgsRight: [] }
        ...
        <div className="container">
          ...
          <div className="chat1">
            ...
            <form onSubmit={this.handleSubmitLeft}>
              <div>
                <input type="text" value={this.state.inputContent} onChange={this.updateInputContentLeft} />
                <input type="submit" />
              </div>
            </form>
          </div>
          ...
          <div className="chat2">
            ...
            <form onSubmit={this.handleSubmitRight}>
              <div>
                <input type="text" value={this.state.inputContent} onChange={this.updateInputContentRight} />
                <input type="submit" />
              </div>
            </form>
          </div>
