...
// Preload game images
var images = {};
['enemy.png', 'bg.jpg', 'test1.png', 'test2.png', 'test3.png', 'bonus.png', 'bullet.png', 'pill.png'].forEach(imgName => {
...
class Clouds {
    constructor() {
        ...
        //this.sprite2 = images['bullet.png'];
...
class Engine {
    ...
    //     while (this.pills.filter(e => !!e).length < MAX_PILLS) {
    //         this.addPill();
    //     }
    // }
    ...
    // addPill() {
    //     var pillSpots = GAME_WIDTH / ENEMY_WIDTH;

    //     var pillSpot;
    //     // Keep looping until we find a free enemy spot at random
    //     while (pillSpot === undefined) {
    //         pillSpot = Math.floor(Math.random() * pillSpots);
    //     }

    //     this.pills[pillSpot] = new Pill(pillSpot * PILL_WIDTH);
    // }
    ...
    gameLoop() {
        ...
        //this.pills.forEach(pill => pill.update(timeDiff));
        ...
        //this.ctx.drawImage(images['bullet.png'], 0, 0);
        ...
        //this.pills.forEach(pill => pill.render(this.ctx)); // draw the enemies
        ...
        // this.pills.forEach((pill, pillIdx) => {
        //     if (pill.y > GAME_HEIGHT) {
        //         delete this.pills[pillIdx];
        //     }
        // });
        // this.setupPills();
    ...
    friendBonus() {
        ...
        return this.friends.some(function (friend) {
            return (friend.x === self.player.x && friend.y + FRIEND_HEIGHT >= self.player.y)
                && (friend.y < self.player.y) + FRIEND_HEIGHT / 4;
    ...
    //     return this.pills.some(function (pill) {
    //         return (pill.x === self.player.x && pill.y + PILL_HEIGHT >= self.player.y)
    //             //&& (pill.y < self.player.y) + PILL_HEIGHT / 4;
